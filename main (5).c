...
void init_spi2(void) {
		...
		SPI2->CR1 &= ~(0b1<<6);
		SPI2->CR1 |= 0b111000;
		SPI2->CR2 |= 0b111100000000;
		SPI2->CR1 |= 0b1<<2;
		//ss and nssp,txdmaen,spi
		SPI2->CR2 |= 0b1<<2;
		SPI2->CR2 |= 0b1<<3;
		SPI2->CR2 |= SPI_CR2_TXDMAEN;
		SPI2->CR1 |= (0b1<<6);//enable spi?
}
...
void init_spi1() {
    ...
    // PA15 SPI1_NSS
		...
		GPIOA->MODER &= ~(GPIO_MODER_MODER5 | GPIO_MODER_MODER6 |GPIO_MODER_MODER15| GPIO_MODER_MODER7);
		GPIOA->MODER |= GPIO_MODER_MODER5_1 | GPIO_MODER_MODER6_1 |GPIO_MODER_MODER15_1 |GPIO_MODER_MODER7_1;

		//RCC->APB2ENR|=RCC_APB2ENR_SPI1EN;
		SPI1->CR1 &= ~(0b1<<6);
		SPI1->CR1 |= 0b111000;
		SPI1->CR2 = 0b100100000000;
		SPI1->CR1 |= 0b1<<2;
			//ss and nssp,txdmaen,spi
		SPI1->CR2 |= 0b1<<2;
		SPI1->CR2 |= 0b1<<3;
		SPI1->CR2 |= SPI_CR2_TXDMAEN;
		SPI1->CR1 |= (0b1<<6);//enable spi?//SPI_CR1_SPE
}
